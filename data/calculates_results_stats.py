...
def calculates_results_stats(results_dic):
    ...
    Z = results_stats_dic["n_images"]
    A = results_stats_dic['n_correct_dogs']
    B = results_stats_dic['n_dogs_img']
    C = results_stats_dic['n_correct_notdogs']
    D = results_stats_dic['n_notdogs_img']
    E = results_stats_dic['n_correct_breed']
    Y = results_stats_dic['n_match']
